...
CHATREP_RULES = [
    ...
    ("selamat sore", ["sore kak", "gas", "oke"], "contains"),
        ...
        # ===== TANYAAN / RESPONS CEPET (VARIAN BANYAK) =====
    ("hah", ["hah", "apaan", "kenapa"], "contains"),
    ("hah?", ["hah", "apaan", "kenapa"], "contains"),
    ("hah anjir", ["waduh", "wkwk", "parah"], "contains"),
    ("gitu", ["iya", "oh gitu", "sip"], "contains"),
    ("oh gitu", ["iya", "sip", "oke"], "contains"),
    ("oh gitu ya", ["iya", "sip", "oke"], "contains"),
    ("terus", ["terus kenapa", "lanjut", "gimana"], "contains"),
    ("trs", ["terus kenapa", "lanjut", "gimana"], "contains"),
    ("trus", ["terus kenapa", "lanjut", "gimana"], "contains"),
    ("jadi", ["jadi gimana", "terus?", "oke"], "contains"),
    ("jadi gimana", ["gatau", "pelan-pelan", "aman"], "contains"),
    ("gimana tuh", ["gatau", "pelan-pelan", "jelasin dong"], "contains"),
    ("maksud", ["maksudnya apa", "hah", "jelasin dong"], "contains"),
    ("maksudnya", ["maksudnya apa", "hah", "jelasin dong"], "contains"),
    ("jelasin", ["jelasin dong", "apa tuh", "hah"], "contains"),
    ("jelas", ["iya", "sip", "mantap"], "contains"),
    ("jelas?", ["iya", "sip", "mantap"], "contains"),
    ("paham", ["sip", "mantap", "oke"], "contains"),
    ("ngerti", ["sip", "mantap", "oke"], "contains"),
    ("ga ngerti", ["hah", "pelan-pelan", "gimana tuh"], "contains"),
    ("gak ngerti", ["hah", "pelan-pelan", "gimana tuh"], "contains"),
    ("bingung", ["santai", "pelan-pelan", "gimana tuh"], "contains"),
    ("confuse", ["santai", "pelan-pelan", "gimana tuh"], "contains"),
    ("serah", ["yaudah", "oke", "sip"], "contains"),
    ("terserah", ["yaudah", "oke", "sip"], "contains"),
    ("yaudah", ["yaudah", "oke", "sip"], "contains"),
    ("ya udah", ["yaudah", "oke", "sip"], "contains"),
    ("yaelah", ["waduh", "wkwk", "santai"], "contains"),
    ("yaelahh", ["waduh", "wkwk", "santai"], "contains"),

    # ===== NANYA KABAR / KONDISI =====
    ("apa kabar", ["baik", "aman", "gimana lu"], "contains"),
    ("kabarmu", ["aman", "baik", "gimana lu"], "contains"),
    ("kabar", ["aman", "baik", "gimana"], "contains"),
    ("gimana kabar", ["aman", "baik", "oke"], "contains"),
    ("sehat", ["sehat dong", "aman", "gas"], "contains"),
    ("sehat?", ["sehat dong", "aman", "gas"], "contains"),
    ("sakit", ["waduh", "gws", "istirahat"], "contains"),
    ("gws", ["gws", "cepet sembuh", "istirahat"], "contains"),
    ("pusing", ["istirahat", "minum dulu", "waduh"], "contains"),
    ("mual", ["waduh", "istirahat", "minum"], "contains"),
    ("demam", ["waduh", "gws", "istirahat"], "contains"),
    ("batuk", ["minum anget", "gws", "istirahat"], "contains"),
    ("flu", ["gws", "istirahat", "minum anget"], "contains"),

    # ===== NANYA LOKASI / KETEMUAN (VARIAN) =====
    ("lokasi", ["lokasi mana", "shareloc", "dimana"], "contains"),
    ("loks", ["lokasi mana", "shareloc", "dmn"], "contains"),
    ("shareloc", ["shareloc dong", "lok mana", "dmn"], "contains"),
    ("sini", ["sini mana", "dmn", "lokasi"], "contains"),
    ("situ", ["situ mana", "dmn", "lokasi"], "contains"),
    ("ketemu", ["gas ketemu", "dmn", "otw"], "contains"),
    ("meet", ["gas ketemu", "dmn", "otw"], "contains"),
    ("ngumpul", ["gas ngumpul", "dmn", "otw"], "contains"),

    # ===== MABAR / VC / CALL (VARIAN) =====
    ("yuk", ["yuk", "gas", "kuy"], "exact"),
    ("kuy", ["kuy", "gas", "yuk"], "contains"),
    ("skuy", ["skuy", "gas", "yuk"], "contains"),
    ("ayok", ["gas", "yuk", "kuy"], "contains"),
    ("ayo", ["gas", "yuk", "kuy"], "contains"),
    ("ayoo", ["gas", "yuk", "kuy"], "contains"),
    ("gas ga", ["gas", "ayo", "kuy"], "contains"),
    ("gass ga", ["gas", "ayo", "kuy"], "contains"),
    ("join vc", ["gas vc", "masuk vc", "yuk"], "contains"),
    ("masuk vc", ["gas", "yuk", "join"], "contains"),
    ("vc mana", ["kirim link", "mana vc", "gas"], "contains"),
    ("call mana", ["kirim link", "mana call", "gas"], "contains"),
    ("link vc", ["mana link", "kirim", "spill"], "contains"),
    ("link call", ["mana link", "kirim", "spill"], "contains"),

    # ===== SOSMED / LINK / FOLLOW =====
    ("ig", ["spill ig", "dm aja", "mana ig"], "contains"),
    ("instagram", ["spill ig", "dm aja", "mana ig"], "contains"),
    ("tiktok", ["spill tiktok", "mana link", "kirim"], "contains"),
    ("tt", ["spill tiktok", "mana link", "kirim"], "contains"),
    ("yt", ["mana link", "spill yt", "kirim"], "contains"),
    ("youtube", ["mana link", "spill yt", "kirim"], "contains"),
    ("follow", ["gas follow", "done", "sip"], "contains"),
    ("follback", ["done", "sip", "gas"], "contains"),
    ("fb", ["done", "sip", "gas"], "contains"),
    ("like", ["gas", "done", "sip"], "contains"),
    ("komen", ["gas", "done", "sip"], "contains"),

    # ===== MINTA / REQUEST (GC BANGET) =====
    ("minta", ["minta apaan", "apa tuh", "hah"], "contains"),
    ("tolong", ["kenapa", "apa tuh", "oke"], "contains"),
    ("bantu", ["kenapa", "apa tuh", "oke"], "contains"),
    ("help", ["kenapa", "apa tuh", "oke"], "contains"),
    ("ajarin", ["gas", "pelan-pelan", "oke"], "contains"),
    ("ajarin dong", ["gas", "pelan-pelan", "oke"], "contains"),
    ("spill dong", ["spill apa", "kirim", "mana"], "contains"),
    ("kirim dong", ["kirim apa", "mana", "oke"], "contains"),
    ("share dong", ["share apa", "mana", "oke"], "contains"),

    # ===== REAKSI KAGET / HERAN / MALU =====
    ("anj", ["waduh", "wkwk", "parah"], "contains"),
    ("buset dah", ["parah", "anjir", "waduh"], "contains"),
    ("serius lu", ["beneran", "fix", "serius"], "contains"),
    ("asli", ["asli", "real", "bener"], "contains"),
    ("asli?", ["asli", "real", "bener"], "contains"),
    ("sumpah", ["sumpah?", "asli?", "waduh"], "contains"),
    ("sumpah?", ["sumpah?", "asli?", "waduh"], "contains"),
    ("malu", ["wkwk", "santai", "cie"], "contains"),
    ("salting", ["cie", "wkwk", "asek"], "contains"),
    ("degdegan", ["cie", "wkwk", "asek"], "contains"),

    # ===== NGOMEL RINGAN (TETEP AMAN) =====
    ("lama", ["sabar", "bentar", "ditunggu"], "contains"),
    ("kelamaan", ["sabar", "bentar", "ditunggu"], "contains"),
    ("kapan sih", ["sabar", "ntar", "bentar"], "contains"),
    ("kapan??", ["sabar", "ntar", "bentar"], "contains"),
    ("cepet", ["iya", "bentar", "sabar"], "contains"),
    ("cepetan", ["iya", "bentar", "sabar"], "contains"),
    ("buruan", ["iya", "bentar", "sabar"], "contains"),
    ("ribet amat", ["santai", "pelan-pelan", "waduh"], "contains"),
    ("kok lama", ["sabar", "bentar", "ditunggu"], "contains"),
    ("ga jelas", ["waduh", "hah", "jelasin"], "contains"),
    ("gak jelas", ["waduh", "hah", "jelasin"], "contains"),

    # ===== MAKAN / MINUM / TIDUR (VARIAN) =====
    ("udah makan", ["met makan", "jangan lupa makan", "mantap"], "contains"),
    ("udah mam", ["met makan", "jangan lupa makan", "mantap"], "contains"),
    ("belom makan", ["makan dulu", "jangan telat", "gas"], "contains"),
    ("belum makan", ["makan dulu", "jangan telat", "gas"], "contains"),
    ("makan apa", ["apa aja", "yang penting makan", "wkwk"], "contains"),
    ("minum", ["minum dulu", "jangan dehidrasi", "gas"], "contains"),
    ("haus banget", ["minum dulu", "jangan dehidrasi", "waduh"], "contains"),
    ("tidur dulu", ["met tidur", "hati-hati", "gas"], "contains"),
    ("ngantuk banget", ["tidur dulu", "met tidur", "istirahat"], "contains"),

    # ===== PENUTUP / PAMIT (VARIAN) =====
    ("dulu", ["gas", "oke", "aman"], "exact"),
    ("cabut dulu", ["gas", "hati-hati", "aman"], "contains"),
    ("aku cabut", ["gas", "hati-hati", "aman"], "contains"),
    ("pergi dulu", ["gas", "hati-hati", "aman"], "contains"),
    ("bye bye", ["gas dulu", "hati-hati", "aman"], "contains"),
    ("dadahh", ["hati-hati", "aman", "gas"], "contains"),
    ("see you", ["gas dulu", "hati-hati", "aman"], "contains"),

        # ===== PANGGILAN RANDOM / TYPO =====
    ("bruh", ["iya bruh", "waduh", "wkwk"], "contains"),
    ("brok", ["iya bro", "apa", "kenapa"], "contains"),
    ("bng", ["siap bang", "kenapa bang", "apa bang"], "contains"),
    ("bg", ["siap bang", "kenapa", "apa"], "contains"),
    ("kkaa", ["iya kak", "kenapa kak", "apa kak"], "contains"),
    ("kakkk", ["iya kak", "kenapa kak", "apa kak"], "contains"),
    ("minn", ["iya min", "kenapa min", "apa min"], "contains"),
    ("admin", ["iya min", "kenapa", "apa"], "contains"),
    ("mod", ["iya min", "kenapa", "apa"], "contains"),
    ("owner", ["iya bos", "kenapa", "apa"], "contains"),

    # ===== “WKWK” VARIAN + KETAWA SPAM =====
    ("wkwkwk", ["wkwk", "ngakak", "ketawa mulu", "kwkw"], "contains"),
    ("wkwkwkwk", ["wkwk", "ngakak", "ketawa mulu"], "contains"),
    ("wkwwk", ["wkwk", "ngakak"], "contains"),
    ("kwkw", ["kwkw", "ngakak", "wkwk"], "contains"),
    ("kwk", ["kwkw", "wkwk"], "contains"),
    ("ngakak", ["ngakak", "wkwk", "parah"], "contains"),
    ("ngakakkk", ["ngakak", "wkwk", "parah"], "contains"),
    ("ketawa", ["wkwk", "ngakak", "ketawa mulu"], "contains"),
    ("lolol", ["wkwk", "ngakak", "lol"], "contains"),

    # ===== REAKSI RAME / SLANG =====
    ("anjrit", ["waduh", "anjir", "parah"], "contains"),
    ("anjirr", ["anjir", "waduh", "parah"], "contains"),
    ("parah sih", ["parah", "anjir", "waduh"], "contains"),
    ("gokil sih", ["gokil", "mantap", "gas"], "contains"),
    ("mantap jiwa", ["mantap", "gas", "sip"], "contains"),
    ("bgs", ["bagus", "mantap", "sip"], "contains"),
    ("bgus", ["bagus", "mantap", "sip"], "contains"),
    ("kocak", ["wkwk", "ngakak", "lucu"], "contains"),
    ("receh amat", ["wkwk", "ngakak", "yaelah"], "contains"),
    ("random", ["wkwk", "aneh ya", "asik"], "contains"),

    # ===== NANYA LINK / FILE / DL =====
    ("mana linknya", ["mana link", "kirim link", "spill link"], "contains"),
    ("linknya mana", ["mana link", "kirim link", "spill link"], "contains"),
    ("send link", ["kirim link", "mana link", "spill"], "contains"),
    ("kirim link", ["gas", "spill link", "mana"], "contains"),
    ("kirim file", ["kirim apa", "mana", "spill"], "contains"),
    ("file", ["file apa", "mana file", "kirim"], "contains"),
    ("dok", ["dok apa", "mana", "kirim"], "contains"),
    ("doc", ["doc apa", "mana", "kirim"], "contains"),
    ("apk", ["apk apaan", "mana link", "spill"], "contains"),
    ("download", ["mana link", "spill", "kirim"], "contains"),
    ("dl", ["mana link", "spill", "kirim"], "contains"),

    # ===== “JOIN / MASUK / INVITE” VARIAN =====
    ("inv", ["invite mana", "kirim link", "gas"], "contains"),
    ("invite", ["invite mana", "kirim link", "gas"], "contains"),
    ("undang", ["undang mana", "kirim link", "gas"], "contains"),
    ("add", ["add kemana", "mana link", "gas"], "contains"),
    ("masukin", ["gas", "mana link", "invite"], "contains"),
    ("join dong", ["mana link", "gas", "kuy"], "contains"),
    ("ajak", ["ajak kemana", "mana link", "gas"], "contains"),
    ("ikut", ["ikut kemana", "mana link", "gas"], "contains"),

    # ===== NANYA STATUS / PROGRESS =====
    ("udah?", ["udah", "belum", "bentar"], "contains"),
    ("udah belum", ["bentar", "sabar", "belum"], "contains"),
    ("udah jadi", ["bentar", "sabar", "otw"], "contains"),
    ("jadi belum", ["bentar", "sabar", "otw"], "contains"),
    ("fix belum", ["bentar", "sabar", "otw"], "contains"),
    ("progress", ["otw", "bentar", "aman"], "contains"),
    ("update", ["otw", "bentar", "aman"], "contains"),
    ("status", ["aman", "otw", "bentar"], "contains"),

    # ===== MINTA BUKTI / SS / PAP (lebih banyak) =====
    ("pap dong", ["gas pap", "mana pap", "spill"], "contains"),
    ("pap dlu", ["gas pap", "mana pap", "spill"], "contains"),
    ("ss dong", ["mana ss", "kirim dulu", "spill"], "contains"),
    ("ss dlu", ["mana ss", "kirim dulu", "spill"], "contains"),
    ("bukti dong", ["mana bukti", "spill", "kirim"], "contains"),
    ("bukti dulu", ["mana bukti", "spill", "kirim"], "contains"),
    ("spill dong", ["spill apa", "kirim", "mana"], "contains"),
    ("spill dlu", ["spill apa", "kirim", "mana"], "contains"),

    # ===== KONDISI / MOOD (VARIAN) =====
    ("mood", ["mood dulu", "santai", "rebahan"], "contains"),
    ("gabut", ["gabut juga", "wkwk", "ngapain"], "contains"),
    ("gabut banget", ["ngapain", "rebahan", "wkwk"], "contains"),
    ("cape", ["istirahat", "rebahan", "santai"], "contains"),
    ("capek banget", ["istirahat", "rebahan", "santai"], "contains"),
    ("bt", ["santai", "tarik napas", "waduh"], "contains"),
    ("badmood", ["santai", "tarik napas", "waduh"], "contains"),
    ("pengen", ["pengen apaan", "hah", "wkwk"], "contains"),
    ("pgn", ["pengen apaan", "hah", "wkwk"], "contains"),

    # ===== JAM / WAKTU RANDOM =====
    ("jam berapa", ["gatau", "cek jam sendiri", "wkwk"], "contains"),
    ("udah jam", ["wkwk", "gas", "yaudah"], "contains"),
    ("malem banget", ["met tidur", "wkwk", "gas dulu"], "contains"),
    ("pagi banget", ["pagi", "gas", "mantap"], "contains"),

    # ===== UCAPAN UMUM TAMBAHAN =====
    ("maaf", ["gapapa", "aman", "santai"], "contains"),
    ("sorry", ["gapapa", "aman", "santai"], "contains"),
    ("sori", ["gapapa", "aman", "santai"], "contains"),
    ("izin", ["oke", "siap", "aman"], "contains"),
    ("permisi", ["iya", "kenapa", "apa"], "contains"),
    ("permisi kak", ["iya kak", "kenapa", "apa"], "contains"),

    # ===== MEMANCING OBROLAN =====
    ("lagi dimana", ["dimana emang", "shareloc", "lokasi mana"], "contains"),
    ("lagi apa", ["biasa", "rebahan", "ngopi"], "contains"),
    ("lg dimana", ["dimana emang", "shareloc", "lokasi mana"], "contains"),
    ("lg apa", ["biasa", "rebahan", "ngopi"], "contains"),
    ("ngapaen", ["biasa", "rebahan", "ngopi"], "contains"),

    # ===== PENUTUP TAMBAHAN LAGI =====
    ("otw tidur", ["met tidur", "hati-hati", "aman"], "contains"),
    ("tidur ya", ["met tidur", "istirahat", "aman"], "contains"),
    ("aku tidur", ["met tidur", "istirahat", "aman"], "contains"),
    ("dah", ["oke", "gas", "yaudah"], "exact"),
    ("dahh", ["oke", "gas", "yaudah"], "contains"),
    ("udh", ["oke", "sip", "yaudah"], "exact"),
    ("udah", ["oke", "sip", "yaudah"], "contains"),
]
